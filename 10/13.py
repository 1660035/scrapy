...
#h3 class="mt-0 my-2
	...
	product_names = soup.find_all('img')
#embed-responsive-item lazyload-img
	type(product_names)
	titles = []
	for i in range(len(product_names)):
		if product_names[i].has_attr('title'): 
	 		titles.append(product_names[i]['title'])
